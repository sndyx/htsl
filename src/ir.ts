import type { PartialAction, PartialActionHolder, PartialCondition } from "housing-common/src/types/partial";
import type { Span } from "./span";
import type { Diagnostic } from "./diagnostic";

type Wrap<T> = {
    value:
        T extends PartialAction ? IrAction :
        T extends PartialCondition ? IrCondition :
...
type WrapArray<U> =
    U extends PartialAction ? IrAction[] :
    U extends PartialCondition ? IrCondition[] :
